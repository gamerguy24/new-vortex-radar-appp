...
const CAMERAS = [
    { name: 'Times Square', url: 'https://www.youtube.com/embed/rnXIjl_Rzy4?autoplay=1', lng: -73.9855, lat: 40.7580 },
    { name: 'Lower Manhattan, NY', url: 'https://www.youtube.com/embed/pEuK-UAtT3s?autoplay=1', lng: -74.0026, lat: 40.7081 },
...
function _openCamPopup(map, cam) {
    ...
    const actionBtns = `<span style="display:flex;align-items:center;gap:4px;margin-left:8px;flex-shrink:0;">
        <button id="cam-fullscreen-btn" title="Fullscreen" style="background:none;border:none;color:#fff;cursor:pointer;font-size:16px;padding:2px;display:inline-flex;align-items:center;"><i class="ti ti-arrows-maximize"></i></button>
        <button id="cam-close-btn" title="Close" style="background:none;border:none;color:#fff;cursor:pointer;font-size:16px;padding:2px;display:inline-flex;align-items:center;"><i class="ti ti-x"></i></button>
    </span>`;
