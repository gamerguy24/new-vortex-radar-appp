...
import { installRadarFurniture } from './pro_radar.js?v=proui8';
...
function loadStylesheet() {
  ...
  link.href = './components/pro_skin.css?v=proui8';
  ...
  radar.href = './components/pro_radar.css?v=proui8';
  ...
  chrome.href = './components/pro_chrome.css?v=proui8';
