...
import { installRadarFurniture } from './pro_radar.js?v=proui7';
...
function loadStylesheet() {
  ...
  link.href = './components/pro_skin.css?v=proui7';
  ...
  radar.href = './components/pro_radar.css?v=proui7';
  ...
  chrome.href = './components/pro_chrome.css?v=proui7';
