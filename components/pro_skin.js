...
import { installRadarFurniture } from './pro_radar.js?v=proui6';
...
function loadStylesheet() {
  ...
  link.href = './components/pro_skin.css?v=proui6';
  ...
  radar.href = './components/pro_radar.css?v=proui6';
  ...
  chrome.href = './components/pro_chrome.css?v=proui6';
