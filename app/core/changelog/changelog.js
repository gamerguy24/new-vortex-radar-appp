...
const CHANGELOG = [
    {
        date: 'August 28, 2026',
        items: [
            { title: 'Vortex PTT — built-in radio', desc: 'Push-to-talk is now part of Vortex Radar itself. Pick a channel, see who’s on it, hold the button and talk — the panel floats over the map so you never leave the radar, and there’s a full-screen version at /ptt. Hold with your mouse, your thumb, or the spacebar (or set your own key). Voice goes straight between chasers rather than through a middleman, and only one person transmits at a time, like a real radio.' },
