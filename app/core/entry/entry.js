...
function load() {
    ...
    // can color-match the map polygons
    window.vortexAlertColors = require('../../alerts/colors/polygon_colors');
    ...
    // load the radar loop / playback controller
    require('../../radar/animation/radar_loop');
